...
/****************************  EDITABLE CONSTANTS  ****************************/
static const uint16_t  BLACK_THRESHOLD         =               460;
static const uint16_t  DRIVE_SPEED_LEFT        =               620;
static const uint16_t  DRIVE_SPEED_RIGHT       =               500;
static const uint16_t  TURN_SPEED              =               150;
